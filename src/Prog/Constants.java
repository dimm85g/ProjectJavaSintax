...
public class Constants {
    ...
    public static final int MODIFIER_CODING = 1; //

    public static final int MODIFIER_DECODING = -1; // It is used to turn the key in the opposite direction, when decrypting by key
    ...
    protected static final String ENCODING = "Шифрование с помощью" + "\nключа";
}
